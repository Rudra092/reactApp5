...
export default function AppAboutInner(){
    return(
        <div className="flex flex-col md:flex-row items-center md:items-start max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6 gap-6 mt-[30px] mb-[30px]">
      {/* Image on the Left */}
